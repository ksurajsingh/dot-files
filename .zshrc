...
#Friday
alias friday='phoneup && notify-send phoneup && kssup && notify-send KSSUP give-password && snapall && notify-send KSS-snapped && phoneup && notify-send Friday done'
...
alias pnsem2pc='rsync -avhUPz  phone:/storage/E452-4B2F/5thsem/ /mnt/KSS/Learnings/rvce/5thsem/ '
...
alias diary='nv /mnt/KSS/Learnings/site/futurediary/"$(date +%a-%b-%d-%Y)".md'
...
alias fzf='fzf --multi '
alias el='cd /mnt/KSS/Learnings/rvce/5thsem/private/el/'
alias lab='cd /mnt/KSS/Learnings/rvce/5thsem/private/lab/'
...
alias archup='yay -Scc && sudo pacman -Scc && sudo pacman -Syu && notify-send Pacman-Updated && yay -Syu'
